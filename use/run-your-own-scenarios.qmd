...
Let's start by exploring what happens if we change fishing in the future. To do this we set up a scenario, where the model starts with the last time step of the fished scenario.
