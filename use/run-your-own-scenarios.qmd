...
In the previous tutorial, we examined a simple  (toothfish, here referred to as *D.ele*).
...
There are a lot of additional plots and results that can be explored from the above scenarios.
