...
sim0 <- projectToSteady(params2, effort = 0, return_sim = TRUE, t_max = 200)
sim <- projectToSteady(params2, effort = 1, return_sim = TRUE, t_max = 200)
...
```{r}
# reset the param and sim names using last set of parameters
