...
Let's compare the current size spectra (averaged over 2015-2020) to the unfished size spectra to assess whether there is any evidence of a size-structured trophic cascade due to fishing.
