...
effort_time <-array(relative_effort, dim = c(length(relative_effort),1), 
...
sim <- project(params, effort = effort_time)
plotYieldGear(sim)
plotBiomass(sim)
...
plotFittedTime(sim,obsY,plotSpecies = "D.ele",startyr = 2003,endyr = 2020)
