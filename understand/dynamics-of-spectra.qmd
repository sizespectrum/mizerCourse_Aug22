...
### Exercise 1
Go back to the example with fishing on individuals above 1kg from the section on [fishing-induced cascades](species-interactions.html#fishing-induced-cascades). Impose the same fishing, but now on the trait-based model with reproduction dynamics left turned on. Project the model for 30 years and look at the animation of the spectra. Then answer the question in the worksheet.
:::
...
So now let us look at the dynamics that is triggered by the reduction in interaction with the resource by species 8 through 11.
