...
In order for the code from the tutorials to work without problems, you should install the versions of the mizer, mizerMR and mizerExperimental packages as they were during August 2022. To do that, follow [these instructions](install-tools.qmd#r-packages).
:::
