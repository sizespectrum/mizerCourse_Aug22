...
If you run into difficulties with the above, please post about it in the comments section at the bottom of this page. If you want to dig in deeper yourself, you can take a look at the [troubleshooting](https://happygitwithr.com/troubleshooting.html) section in "[Happy Git and GitHub for the useR](https://happygitwithr.com/index.html)".
