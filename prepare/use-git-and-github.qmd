...
When you hit the refresh button on your browser after a just a short moment, you should see a page with a URL for your new repository on GitHub at the bottom.

![](screenshots/ready-to-go.png){width="80%" fig-align="center"}

Please follow that URL to your repository. This repository home page displays the README at the bottom. There you for example find a progress bar where you accumulate points as you complete the exercises in the worksheet. We are now interested in the big green "Code" button, which when clicked will give a popup button with the URL for cloning your repository.
