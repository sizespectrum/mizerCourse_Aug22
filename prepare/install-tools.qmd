...
The mizerExperimental package is for code that is still experimental and thus changes frequently. Therefore it is hosted in a [GitHub repository](https://github.com/sizespectrum/mizerExperimental). We need the package in the form from August 2022. You install it with
...
Finally, while the latest release of the mizer package can be installed from
CRAN as described above, for this course we need the version from August 2022:
