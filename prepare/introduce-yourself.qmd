...
When you post a comment you will be asked to log in to GitHub. You will probably already have an account on GitHub. If not, please create one for yourself. You will need it to participate in this course. The page [Use Git and GitHub](use-git-and-github.qmd) explains how we will use GitHub in this course. 
