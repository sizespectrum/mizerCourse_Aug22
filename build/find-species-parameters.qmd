...
```{r}
curonian_params <-  read_csv("build/curonian_params_noRoach.csv")
...
```{r}
curonian_interaction <- read.csv("build/curonian_interaction_noRoach.csv")
...
```{r}
species_params(curon) |> select(species, w_inf, a, b, f0, alpha) 
...
```{r}
curon_interaction <-  read_csv("build/curonian_interaction.csv")
curon_interaction
