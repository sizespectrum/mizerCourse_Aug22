...
3.  [**Add multiple resources to your model**](set-multiple-resources.qmd)\
    In this tutorial we will use mizerMR extension to add benthic resource spectrum to the model. We will explore how to adjust resource availability to achieve realistic ontogenetic changes in diets. 
