...
For all meetings go to the course meeting link at [**https://live.remo.co/e/mizer-course-meetings**](https://live.remo.co/e/mizer-course-meetings) **Note!** For security reasons, this link will only be open to the registered participants, based on the email address used for the registration. If you need to use another email address, please send an email from your that email address to [gustav.delius\@gmail.com](mailto:gustav.delius@gmail.com) and he will add you to the safe list.
