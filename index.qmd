...
For all meetings go to the course meeting link at
[**https://live.remo.co/e/mizer-course-meetings**](https://live.remo.co/e/mizer-course-meetings)
**Note!** For security reasons, this link will only be open to the registered participants, based on the email address used for the registration. If you need to use another email address, please contact course organisers, and we will add you to the safe list.
...
This course is organised as a part of ["Sustainable inland fisheries"](https://sif.lt) project and is funded by the European Regional Development Fund (project No 01.2.2-LMT-K-718-02-0006) under grant agreement with the Research Council of Lithuania (LMTLT).
