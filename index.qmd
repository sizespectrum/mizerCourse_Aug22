...
There will be several online meeting scheduled throughout the course, see the list of meetings in the table below. **All times are indicated in UK summer time, GMT+1.** For each day we organise two meetings to accommodate different time zones:
